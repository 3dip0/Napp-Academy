...
class TestMyCalendar:
    ...
    def test_method_check_holiday_1(self):
        ...
        assert objeto.check_holiday(dt1) is True
        assert objeto.check_holiday(dt4) is True
    ...
    def test_method_check_holiday_2(self):
        ...
        assert objeto.check_holiday(dt1) is True
        assert objeto.check_holiday(dt2) is True
        assert objeto.check_holiday(dt3) is True
...
x.test_method_add_holiday_1()
x.test_method_add_holiday_2()
x.test_method_add_holiday_3()
x.test_method_add_holiday_4()
x.test_method_add_holiday_5()
x.test_method_check_holiday_3()