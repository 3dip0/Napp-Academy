from mercado.classes.Produto import Produto
import pytest
...
class TestProduto:
    ...
    def test_instanciar_objeto_somente_descricao(self):
        objeto = Produto(descricao='Agua com gas')
        assert objeto.descricao, 'Agua com gas'
        assert objeto.preco == 0
